...
const request: Request = {
  ...
  // The hash is generated by the PayOne PCP JavaScript Client SDK.
};
```
...
In addition to the Client-SDK, we also provide multiple Server-SDKs. If you want to directly expose PCP compliant objects from your client, you can find all the necessary interfaces within the interfaces folder.
...
By following these steps, you can efficiently manage and streamline the release process for the PayOne PCP JavaScript Client SDK, ensuring that the new release is published from the `master` branch while maintaining consistency and reliability.

## Minimum Supported Browser Versions

The PayOne PCP JavaScript Client SDK targets ES6 (ECMAScript 2015) and supports the following minimum browser versions:
